...
export const KENTEI_SPEC: Record<Grade, GradeSpec> = {
  ...
  5:  { mul:{digitsSum:6,count:20,minutes:10,digitsPairs:[[2,4],[3,3],[4,2]]},  div:{digitsSum:5,count:20,minutes:10,digitsPairs:[[2,3],[3,2]]},  mitori:{digitsMin:3,digitsMax:4,count:10,minutes:8,terms:7,allowNegativeFromTerm:3}},
  6:  { mul:{digitsSum:5,count:20,minutes:10,digitsPairs:[[2,3],[3,2]]},  div:{digitsSum:4,count:20,minutes:10,digitsPairs:[[2,2]]},  mitori:{digitsMin:2,digitsMax:3,count:10,minutes:8,terms:7,allowNegativeFromTerm:2}},
  7:  { mul:{digitsSum:4,count:20,minutes:10,digitsPairs:[[2,2]]},  div:{digitsSum:4,count:20,minutes:10,digitsPairs:[[1,3]]},  mitori:{digitsMin:2,digitsMax:3,count:10,minutes:8,terms:5,allowNegativeFromTerm:3}},
